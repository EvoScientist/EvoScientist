...
- **🔄 Code Generation Modes** — Choose Lite (single-pass) or More Effort (iterative plan → code → evaluate → refine) per conversation via `experiment-iterative-coder` skill.
