...
- **[2026 年 3 月 25 日]** 🥇 提交时在 [AstaBench 代码与执行排行榜](https://huggingface.co/spaces/allenai/asta-bench-leaderboard) 排名第一！[**排行榜**](https://allenai-asta-bench-leaderboard.hf.space/code-execution) 👈
