...
- **[2026 年 8 月 29 日]** **[v0.2.9](https://github.com/EvoScientist/EvoScientist/releases/tag/v0.2.9)** — 新增模型：GLM-5.3-Flash（智谱、智谱代码计划、OpenRouter）、Qwen3.8-Flash（DashScope、阿里云代码计划、OpenRouter）、腾讯 HY4 preview（OpenRouter），均为 1M 上下文；升级 deepagents 0.7.11。
